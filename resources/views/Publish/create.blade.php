...
@section('title') Publish Document @endsection
...
@section('content')
    ...
    @component('common-components.breadcrumb')
        @slot('title') PUBLISH DOCUMENT @endslot
    ...
    <!-- END Display Message-->
        <form id="my_form" action="{{ route('publish.submit') }}" method="POST" class="needs-validation outer-repeater" enctype="multipart/form-data" novalidate> <!--class="needs-validation outer-repeater"-->
            @csrf 
                <div class="row"> 
                    <div class="col-lg-6">
                        <div class="card">
