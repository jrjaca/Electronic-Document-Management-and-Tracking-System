...
@section('title') List of New Registered Users @endsection
...
@section('content')
    ...
    @component('common-components.breadcrumb')
        @slot('title') NEW REGISTERED USERS @endslot
        @slot('li_1') <a title="Back to Home" href="{{route('index')}}">Home</a> @endslot
        @slot('li_2') List of New Users @endslot
    @endcomponent 
                        ...
                        <table id="datatable-buttons" class="table table-striped table-bordered dt-responsive" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                            <thead>
                                <tr>
                                    ...
                                    @if(Gate::check('user_activate') || Gate::check('user_disable') || Gate::check('user_enable'))
