...
@section('title') Transferer Within Office @endsection
...
@section('content')
    ...
    @component('common-components.breadcrumb')
        @slot('title') TRANSFER WITHIN OFFICE @endslot
        @slot('li_1') <a title="Back to Home" href="{{route('index')}}">Home</a> @endslot
        @slot('li_2') List of Transferees Within Office for Approval @endslot
    @endcomponent 
