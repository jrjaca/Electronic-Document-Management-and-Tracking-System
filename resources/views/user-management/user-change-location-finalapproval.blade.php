...
@section('title') Transfer Final Approval @endsection
...
@section('content')
    ...
    @component('common-components.breadcrumb')
        @slot('title') TRANSFER FINAL APPROVAL @endslot
        @slot('li_1') <a title="Back to Home" href="{{route('index')}}">Home</a> @endslot
        @slot('li_2') List of Transferees for Final Approval @endslot
    @endcomponent 
                        ...
                        <table id="datatable-buttons" class="table table-striped table-bordered dt-responsive" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                            <thead>
                                <tr>
                                    ...
                                    {{-- <th style="text-align:center;">Current Admin Approval Status</th>
                                    <th style="text-align:center;">Approval Status from New Location</th> --}}
                            ...
                            @foreach($transferees as $key => $row)    
                                <tr>
                                    ...
                                    {{-- <td style="text-align:center;">{{ $row->user_id_admin_from }}</td>
                                    <td style="text-align:center;">{{ $row->user_id_admin_to }}</td>                                 --}}
