...
@section('title') Document Routing @endsection
...
@section('content')
    ...
    @component('common-components.breadcrumb')
        @slot('title') DOCUMENT ROUTING @endslot
        @slot('li_1') <a title="Back to Home" href="{{route('index')}}">Home</a> @endslot
        @slot('li_2') <a title="Back to Route Management" href="{{route('route.index')}}">Route Management</a> @endslot
        @slot('li_2') <a title="Back to Previous" href="javascript:history.back()">Back to Previous</a> @endslot 
        @slot('li_3') Create document routing @endslot
    @endcomponent  

    <!-- Start Display Message-->
    @include('layouts.flash-message')
    <!-- END Display Message-->
        <form id="my_form" action="{{ route('route.releasing') }}" method="POST" class="needs-validation outer-repeater" enctype="multipart/form-data" novalidate> <!--class="needs-validation outer-repeater"-->
            @csrf 
            <div class="row"> 
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <input type="hidden" name="tracking_no" value="{{ $tracking_no }}" readonly >
                                ...
                                <div class="form-group row mb-4">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" class="form-control"  name="title" maxlength="200" value="{{ old('title')}}" required autofocus>
            ...
            {{-- <div class="form-group row justify-content-end"> --}}
                <div style="text-align: center;">
                    ...
                    <button type="submit" class="btn btn-primary w-md" name="save_btn" value="submit_val">Released</button>   
                </div> <br /><br />
            {{-- </div> --}}
