...
@section('title') List of Submitted Documents @endsection
...
@section('content')
    ...
    @component('common-components.breadcrumb')
        @slot('title') SUBMITTED DOCUMENTS @endslot
        @slot('li_1') <a title="Back to Home" href="{{route('index')}}">Home</a> @endslot
        @slot('li_2') List of Submitted Documents @endslot
    @endcomponent  
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <table id="datatable" class="table table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                            ...
                            <tbody>
                                @foreach($submitted_docs as $key => $row)  
                                <tr>
                                    <td>{{ $key +1 }}</td>
                                    ...
                                    <td>    
                                        ...
                                        @if(Gate::check('publish_document'))    
                                            <a href="{{ route('publish.routeddoc.create', ['id' => Hasher::encode($row->document_id)]) }}">
                                                <span style="font-size: 1.2em; color: Dodgerblue;">
                                                    <i class="fas fa-cloud-upload-alt" title="Publish {{ $row->title }}"></i>
                                                </span></a>
                                        @endif        
