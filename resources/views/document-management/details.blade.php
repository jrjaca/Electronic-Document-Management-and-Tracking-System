...
@section('content')
    ...
    @component('common-components.breadcrumb')
        ...
        @slot('li_2') <a title="Back to List of Released Documents" href="{{route('document.released.list')}}">Released</a> @endslot
        @slot('li_3') Document details @endslot
    @endcomponent  
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            @endforeach
                                ...
                                <input type="hidden" name="recipient_id" value="{{ $doc[0]->user_id }}" readonly>  {{-- user_id from document/creator --}}
