...
@section('title') List of {{ $published_docs[0]->document_type_desc }} @endsection
...
@section('content')
    ...
    @component('common-components.breadcrumb')
        @slot('title') {{ strtoupper($published_docs[0]->document_type_desc) }} @endslot
        @slot('li_1') <a title="Back to Home" href="{{route('index')}}">Home</a> @endslot
        @slot('li_2') <a title="List of Published Documents" href="javascript:history.back()">Back to List of Published Documents</a> @endslot
        @slot('li_3') List of {{ $published_docs[0]->document_type_desc }} @endslot
    @endcomponent  
