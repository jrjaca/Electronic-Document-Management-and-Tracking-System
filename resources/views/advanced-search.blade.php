...
@section('content')
    ...
    @component('common-components.breadcrumb')
        @slot('title') ADVANCED SEARCH @endslot
        @slot('li_1') <a title="Back to Home" href="{{route('index')}}">Home</a> @endslot
        @slot('li_2') Search Document @endslot
    @endcomponent  
    ...
    <!-- END Display Message-->
        ...
        <form id="my_form" action="{{ route('searching') }}" method="POST" class="needs-validation outer-repeater" enctype="multipart/form-data" novalidate> <!--class="needs-validation outer-repeater"-->
            @csrf 
                <div class="row"> 
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-2">
                                        <div class="form-group position-relative">
                                            ...
                                            <select name="document_type_id" autofocus
                                    ...
                                    <div class="col-md-2">
                                        <div class="form-group position-relative">
                                            ...
                                            <input type="text" class="form-control"  name="title" maxlength="100" value="{{ old('title')}}" >
                                        </div>
                                    </div>
                                    {{-- <div class="form-group row mb-4">
                                    ...
                                    <div class="col-md-2">
                                        <div class="form-group position-relative">
                                            ...
                                            <input type="text" class="form-control"  name="attachment_name" maxlength="100" value="{{ old('attachment_name')}}">
                                        </div>
                                    </div>
                                    {{-- <div class="form-group row mb-4">
                                        <label for="horizontal-title-input" class="col-sm-3 col-form-label">Attachment name</label>
                                        <div class="col-sm-3">
                                            <input type="text" class="form-control"  name="attachment_name" maxlength="100" value="{{ old('attachment_name')}}">
                                        </div>
                                    </div> --}}
                                    ...
                                    <div class="col-md-2">
                                        <div class="form-group position-relative">
                                            ...
                                            <input class="form-control" type="date" value="yyyy-mm-dd" name="published_at_start">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-2">
                                        <div class="form-group position-relative">
                                            ...
                                            <input class="form-control" type="date" value="yyyy-mm-dd" name="published_at_end">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-2">
                                        <div class="form-group position-relative">
                                            <label>Remarks</label>
                                            <input type="text" class="form-control" name="remarks" maxlength="100" value="{{ old('remarks')}}">
                                        </div>
                                    </div>
                                    {{-- <div class="form-group row mb-4">
                                ...
                                {{-- <div class="form-group row justify-content-end"> --}}
                                    <div style="text-align: center;">
                                        ...
                                        <button type="submit" class="btn btn-primary w-md" name="search_btn" value="submit_search">Search</button>   
                                    </div> 
                                {{-- </div> --}}
                            </div>
                        </div>
